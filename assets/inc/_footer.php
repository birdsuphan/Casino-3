...
if(UserLoggedIn() == false and $file_name == "index.php") {
...
if(!in_array($file_name,array("faucet.php","index.php","admin.php","admin_cmd.php"))) {
	
echo settings('footerAdCode');	
	
}

$text = array("Coded","Crafted","Developed","Designed","Made","Built","Hand-made","Programmed");
shuffle($text);

?>


<?php if(UserLoggedIn() == true && settings("ChatEnabled") == true) { ?>

<div id="chatbox_div" style="display:none;">
<div class="shout_box">
...
overflow:auto; border: 1px solid #333333;
height:400px;
...
<center>
    <div class="navbar-collapse collapse" id="navbar-main" style="display: inline-block!important;">
        <ul class="nav navbar-nav" style="font-size: 17px">

            <!--<li><a href="news"><i class="fa fa-newspaper-o"></i> &nbsp; News</a></li>-->

            <li><a href="Refer_a_friend">Refer a friend</a></li>
            <li><a href="Provably_fair">Provably fair</a></li>
...
<p class="pull-left">Copyrighted <b><?php echo $website_name; ?></b> <?php echo date("Y"); ?></p>
<p class="pull-right"><?php echo $text[0]; ?> with <font color="red" size="4"><i class="glyphicon glyphicon-heart"></i></font> at <b><a href="https://overfeat.com/">Overfeat</a></b></p>
</div>
</footer>
