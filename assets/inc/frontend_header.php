...
<ul class="nav navbar-nav main_nav" style="font-size: 17px">
...
<li><a href="VIP_club">VIP Club</a></li>
<?php if(settings("forums") == 1){?><li><a href="forums">
...
<li><a href="#address_panel">Deposit</a></li>
</ul>
</li>
...
<li><a href="register"><i class="fa fa-users"></i> &nbsp; Join</a></li>
    <li><a href="contact">
