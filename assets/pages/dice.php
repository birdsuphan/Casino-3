...
<p style="font-size:16px;"><b><span id="serverMessage">Processing...</span></b></p>
...
<input type="text" class="form-control" value="1.01" id="payout" onkeyup="calculateAmounts(3);" onchange="calculateAmounts(4); calculateAmounts(5); calculateAmounts(6);">
</div>
</div>
</div>
...
<center><a onclick="sendBet(1);" class="btn btn-primary btn-lg" id="betbtn">Bet <b>Hi</b></a> &nbsp; <a onclick="sendBet(2);" class="btn btn-primary btn-lg" id="betbtn">Bet <b>Lo</b></a></center>
    ...
    <br>
<center><a href="history?id=3" class="btn btn-sm btn-success">History</a> &nbsp; <a onclick="proveFair();" class="btn btn-sm btn-success">Provably Fair</a></center>
