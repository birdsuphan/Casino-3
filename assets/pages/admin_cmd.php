...
<h4>Minimum Bet:</h4>
<input type="text" name="coinFlip_minBet" value="<?php echo settings('coinFlip_minBet'); ?>" class="form-control">

<br>

<h4>Maximum Bet:</h4>
<input type="text" name="coinFlip_maxBet" value="<?php echo settings('coinFlip_maxBet'); ?>" class="form-control">

<br>

<h4>Referral Percentage:</h4>
<input type="text" name="refPercentageCoinFlip" value="<?php echo settings('refPercentageCoinFlip'); ?>" class="form-control">

<br>

<h4>Game Return Percentage:</h4>
<input type="text" name="CoinFlipReturn" value="<?php echo settings('CoinFlipReturn'); ?>" class="form-control">
...
$rc = mysqli_query($con,"SELECT COUNT(id) AS id FROM flip_wins ORDER BY id DESC");
$numrows = mysqli_fetch_array($rc);
...
$query = mysqli_query($con,"SELECT id,datetime,bet_amt,win_amount,win,roll_number FROM flip_wins ORDER BY id DESC LIMIT $offset, $records");
...
echo  '<td>' . $r['win_amount'] . '</td>';
echo  '<td>' . $victory . '</td>';
echo '<td><a href="ahax?method=show_details&id=' . $r['id'] . '" target="_blank">Details</a> / <a href="verify?method=flip&id=' . $r['id'] . '" target="_blank">Verify</a></td>';
echo '</tr>';
